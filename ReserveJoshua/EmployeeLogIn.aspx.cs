...
namespace ReserveJoshua
{
    public partial class EmployeeLogIn : System.Web.UI.Page
    {
        ...
        protected void btnSignIn_Click(object sender, EventArgs e)
        {
            ...
            string query = "SELECT COUNT(1) FROM EmployeeLogIn WHERE UserName=@UserName AND PassWord=@PassWord";
            ...
            if (count == 1)
            {
                ...
                Response.Redirect("~/ReservationPortal.aspx");
            }
            else
            {
        ...
        protected void btnSend_Click(object sender, EventArgs e)
        {
            ...
            string query = "SELECT COUNT(1) FROM EmployeeLogIn WHERE SecurityAnswer=@SecurityAnswer";
            SqlCommand authorize = new SqlCommand(query, Con);
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand sqlCmd = new SqlCommand("dbo.EmpUpdatePassWord", Con);
            sqlCmd.CommandType = CommandType.StoredProcedure;
            sqlCmd.Parameters.AddWithValue("@Email", (hfEmail.Value == "" ? 0 : Convert.ToInt32(hfEmail.Value)));
            sqlCmd.Parameters.AddWithValue("@PassWord", txtNewPassword.Text.Trim());
            sqlCmd.ExecuteNonQuery();
            Con.Close();
            string memberID = hfEmail.Value;
            Clear();
        ...
        protected void lnk_OnClick(object sender, EventArgs e)
        {
            ...
            hfEmail.Value = contactID.ToString();
