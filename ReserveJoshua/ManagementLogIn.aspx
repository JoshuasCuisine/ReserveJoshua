<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManagementLogIn.aspx.cs" Inherits="ReserveJoshua.ManagementLogIn" %>
...
<body>
    ...
    <div class="center image">
        ...
        <asp:HiddenField ID="hfManagerID" runat="server" />
            ...
            <asp:TemplateField>
               <ItemTemplate>
                  <asp:LinkButton ID="lnkView" runat="server" CommandArgument='<%# Eval("ManagerID") %>' OnClick="lnk_OnClick"></asp:LinkButton>
               </ItemTemplate>
            </asp:TemplateField>
            <br />
            <br />
