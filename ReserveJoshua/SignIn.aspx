<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SignIn.aspx.cs" Inherits="ReserveJoshua.SignIn" %>
    ...
    <div class="center image">
        ...
        <div class="center bar2">
            ...
            <table style="margin:auto; border:5px solid white">
                <tr>
                    <td>
                        <asp:Label ID="Label1" runat="server" Text="Username" BackColor="#BCCEDC"></asp:Label></td>
                    <td>
                        <asp:TextBox ID="txtUserName" runat="server" ></asp:TextBox></td>
                </tr>
                <tr>
                    <td>
                        <asp:Label ID="Label2" runat="server" Text="Password" BackColor="#BCCEDC"></asp:Label></td>
                    <td>
